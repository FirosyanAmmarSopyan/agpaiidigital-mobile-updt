...
const DropdownClass = () => {
  ...
  return <>
      <Box bg="#F6F6F6" w="360" maxW="360">
        <Select borderRadius="20" fontSize="14" dropdownCloseIcon={<Icon size="7" as={MaterialIcons} name="keyboard-arrow-down"/>} dropdownOpenIcon={<Icon size="7" as={MaterialIcons} name="keyboard-arrow-up"/>} selectedValue={service} minWidth="200" placeholder="Kelas" fontWeight="bold" placeholderTextColor="black" mt={1} onValueChange={itemValue => setService(itemValue)}>
